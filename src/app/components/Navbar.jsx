      ...
      <nav className="w-full shadow-md px-4 md:px-8 py-3 relative">
        <div className="flex justify-between items-center container mx-auto gap-5">
          ...
          <div className="hidden sm:block w-1/2">
           ...
           {/* User Profile or Sign In/Sign Up Links */}
           <div className="flex items-center gap-4">
            {session ? (
              // Show Profile Picture and Logout if user is logged in
              <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-4">
                <Link
                  href="/signin"
                  className="text-black text-xl transition-all duration-300 hover:text-red-500"
                >
                  Sign In
                </Link>
                <Link
        ...
        >
          ...
          {session ? (
            <button
              onClick={() => signOut({ callbackUrl: "/signin" })}
              className="block px-4 py-2 mt-2 text-red-500 w-full text-start hover:bg-gray-100"
            >
              Logout
            </button>
          ) : (
